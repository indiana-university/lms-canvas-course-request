...
If launching in administration mode, add "is_admin_mode=true".  If not launching in the
...
<tr><td>Initiate login URL</td><td>http://localhost:8080/lti/login_initiation/lms_siterequest</td></tr>
